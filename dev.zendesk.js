window.Thanx = {
  ...
  adminUrl: 'https://admin-v2.thanxstaging.com',
  ...
  Workspace: new Class({
    ...
    idActions: function(){
      return new Element('div', {
        ...
        new Element('a', {
          href: Thanx.adminUrl +"/admin/users/" + this.getUserId(),
          target: 'admin',
          events: {
      ...
      if (user.name && user.email){
        return new Element('div', {
          ...
          new Element('span', {styles: { display: 'inline-block'}}).adopt(
            ...
            new Element('a', {
              href: Thanx.adminUrl + "/admin/user_search?user=" + user.email,
              target: 'admin',
              events: {
                click: this.adminClickHandler.bind(this),
              },
            ...
            new Element('a', {
              href: Thanx.adminUrl + "/admin/user_search?user=" + user.name,
              target: 'admin',
              events: {
                click: this.adminClickHandler.bind(this),
              },
  ...
  ProgressForm: new Class({
    ...
    getForm: function(){
      ...
      this.date = new Element('input.span2', {
        type: 'text',
        placeholder: "e.g. " + today.getFullYear() + "-" + today.getMonth() + "-" + today.getDate(),
        styles: { marginRight: 4 }
      });
